...
export const IcoKeywords = () => (
  <svg width="18" height="18" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2">
    <circle cx="11" cy="11" r="8" />
    <path d="M21 21l-4.35-4.35" />
  </svg>
)
export const IcoAudit = () => (
  <svg width="18" height="18" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2">
    <path d="M9 11l3 3L22 4" />
    <path d="M21 12v7a2 2 0 01-2 2H5a2 2 0 01-2-2V5a2 2 0 012-2h11" />
  </svg>
)
export const IcoSERP = () => (
  <svg width="18" height="18" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2">
    <polyline points="22 12 18 12 15 21 9 3 6 12 2 12" />
  </svg>
)
export const IcoStrategy = () => (
  <svg width="18" height="18" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2">
...
export const IcoEye = ({ off = false }: { off?: boolean }) =>
  off ? (
...
export const IcoArrow = ({ dir = 'up' }: { dir?: 'up' | 'down' | 'right' }) => {
  if (dir === 'up')
    return (
...
export const IcoSort = ({ active = false, dir = 'asc' }: { active?: boolean; dir?: string }) => (
  <svg width="12" height="12" viewBox="0 0 24 24" fill="none" stroke={active ? '#2563EB' : '#9CA3AF'} strokeWidth="2.5">
    {dir === 'asc' ? <polyline points="6 9 12 15 18 9" /> : <polyline points="18 15 12 9 6 15" />}
  </svg>
)
export const IcoZap = () => (
